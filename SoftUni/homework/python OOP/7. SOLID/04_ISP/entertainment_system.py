...
class Television(RCAConnector, HDMIConnector, PowerOutletConnect):
...
class DVDPlayer(HDMIConnector, PowerOutletConnect):
...
class GameConsole(HDMIConnector, EthernetConnector, PowerOutletConnect):
    def connect_to_tv(self, television):
        self.connect_to_device_via_hdmi_cable(television)
...
class Router(EthernetConnector, PowerOutletConnect):
    def connect_to_tv(self, television):
